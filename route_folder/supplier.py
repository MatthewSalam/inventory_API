...
async def create_supplier(supplier: SupplierBase, db: dbDepend):
    """Add a new suppler."""
...
def get_active_suppliers(db: dbDepend):
...
def get_inactive_suppliers(db: dbDepend):
...
def get_supplier(supplier_id: int, db: dbDepend):
...
def update_supplier(supplier_id: int, updated: SupplierBase, db: dbDepend):
...
def deactivate_supplier(supplier_id: int, db: dbDepend):
...
def reactivate_supplier(supplier_id: int, db: dbDepend):
